...
export default function Play() {
  ...
  useEffect(() => {
    const fetchForm = async () => {
      try {
  const res = await fetch(`https://questioneditor-backend.onrender.com/api/forms/${id}`);
  ...
  const res = await fetch(`https://questioneditor-backend.onrender.com/api/forms/${form._id}/response`, {
        method: "POST",
